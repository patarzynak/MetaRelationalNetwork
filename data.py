...
from better_datasets import AlmostClevrFewShotDataset
...
class AlmostClevrMetaLearningSystemDataLoader(object):
    def __init__(self, args):
        self.batch_size = args.batch_size
        self.num_workers = args.num_dataprovider_workers
        self.args = args
    ...
    def get_train_batches(self, total_batches):
        ...
        dataset = AlmostClevrFewShotDataset(question_templates, size=total_batches*self.batch_size, n=self.n, seed=0)
        return self.get_dataloader(dataset)

    def get_val_batches(self, total_batches):
        question_templates = [
        ...
        dataset = AlmostClevrFewShotDataset(question_templates, size=total_batches*self.batch_size, n=self.n, seed=999999)
        return self.get_dataloader(dataset)

    def get_test_batches(self, total_batches):
        question_templates = [
            "What is the colour of the object furthest away from the <SHAPE>?",
            "What is the colour of the object closest to from the <COLOUR> object?",
            "What is the shape of the object furthest away from the <SHAPE>?",
        ...
        dataset = AlmostClevrFewShotDataset(question_templates, size=total_batches*self.batch_size, n=self.n, seed=99999999)
        return self.get_dataloader(dataset)
